                ...
                "ambient_actions": [
                    {
                        ...
                        # IDENTIDAD SEMÁNTICA DE POSE (DEC-099): esta acción
                        # ARRANCA y TERMINA en la pose base estable de Bunny,
                        # así que el compilador NO la aproxima -- compila esas
                        # dos puntas desde el ARCHIVO de la base, con la
                        # transforma de la base. El frame compilado sale
                        # idéntico byte a byte al que el runtime muestra
                        # cuando Bunny está quieto, sin ninguna tolerancia de
                        # por medio.
                        #
                        # Reemplaza `align_endpoint_to_target_base` (DEC-092/
                        # 095/098), que medía qué tan cerca quedaba la punta y
                        # ajustaba escala/colocación para achicar la
                        # diferencia. Medido: ese camino dejaba un residual de
                        # hasta 0.26% por resampleo entero, imposible de
                        # eliminar con más precisión de medición -- ver el
